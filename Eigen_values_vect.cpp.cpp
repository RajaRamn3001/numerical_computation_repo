...
int main() {
	...
	vector<vector<double>> A1 = {{-4,0,0.5,0.5},{0.5,-2,0,0.4},{0.5,0.5,0,0},{0,1,1,4}};
	vector<vector<double>> x1= {{0},{0},{0},{1}};
    vector<vector<double>> A2 = {{1,-1,0},{-2,4,-2},{0,-1,2}};
	vector<vector<double>> x2= {{-1},{2},{1}};
	EigenVect_values eig;
    show(A1);
    show(x1);
	eig=normalised_power_iteration(A1,x1,MAX_ITER,accuracy);
    cout<<"By normalised power iteration ans:"<<endl;
    cout<<"Eigen vector:"<<endl;
	show(eig.eigen_vect);
    cout<<"Max eigen value"<<endl;
    cout<<eig.eigen_value<<endl;
    eig=inverse_iteration_method(A1,x1,MAX_ITER,accuracy);
    cout<<"By inverse iteration method ans:"<<endl;
    cout<<"Eigen vector:"<<endl;
	show(eig.eigen_vect);
    cout<<"Min eigen value"<<endl;
    cout<<eig.eigen_value<<endl;
    show(A2);
    show(x2);
    eig=normalised_power_iteration(A2,x2,MAX_ITER,accuracy);
    cout<<"By normalised power iteration ans:"<<endl;
    cout<<"Eigen vector:"<<endl;
	show(eig.eigen_vect);
    cout<<"Max eigen value"<<endl;
    cout<<eig.eigen_value<<endl;
    eig=inverse_iteration_method(A2,x2,MAX_ITER,accuracy);
    cout<<"By inverse iteration method ans:"<<endl;
    cout<<"Eigen vector:"<<endl;
	show(eig.eigen_vect);
    cout<<"Min eigen value"<<endl;
